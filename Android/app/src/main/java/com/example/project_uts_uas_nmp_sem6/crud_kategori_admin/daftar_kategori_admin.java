...
public class daftar_kategori_admin extends AppCompatActivity implements AdaptorKategori.DataChangeListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_daftar_kategori_admin);
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(daftar_kategori_admin.this, simpan_data_kategori.class); // Start SimpanData activity
        ...
        StringRequest request = new StringRequest(
                        ...
                        try {
                            ...
                            for (int i = 0; i < jsonArray.length(); i++) {
                                ...
                                model.add(new GetDataKategori(
                                        ...
                                        getData.getString("keterangan")
                                ));
                            }

                            adaptor = new AdaptorKategori(daftar_kategori_admin.this, model, progressBar, daftar_kategori_admin.this);
                            listView.setAdapter(adaptor);
                            Log.d("daftaruser", "Data loaded successfully");

                        } catch (JSONException e) {
                            Log.e("daftaruser", "JSON Parsing error: " + e.getMessage());
                            Toast.makeText(daftar_kategori_admin.this, "Error parsing data", Toast.LENGTH_SHORT).show();
                            reloadData();
                        }
                    }
                },
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError volleyError) {
                        ...
                        Toast.makeText(daftar_kategori_admin.this, "Terjadi kesalahan saat memuat data", Toast.LENGTH_SHORT).show();
                        reloadData();
                    }
                });
